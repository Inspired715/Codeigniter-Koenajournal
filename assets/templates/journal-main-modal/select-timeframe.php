<ul class="list-group list-group-flush <?php echo '$tmclass';?>" style="<?php echo '$style';?>" >
    ...
    <li class="list-group list-group-flush">
        <div class='image-wrapper' >
            <a id="container-<?=$timeframeId?>" class="fancybox gallery-item" rel="editor-808273962-gallery-1" href="#" data-size="1920x1080" gal-index="<?=$timeframeId?>">
    ...
    <div style="width: 100%; display: inline-flex; justify-content: space-between; padding-top: 0.5rem;">
    	...
    	<button type="button" class="btn btn-danger " id="deleteTimeframe-<?=$timeframeId?>" data-timeframe="<?=$timeframeId?>" ><i class="ion-trash-a"></i></button>
    </div>
    </div>
</ul>